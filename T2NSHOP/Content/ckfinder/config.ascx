...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        if (Session["CKFinder_UserRole"] == "Admin")
        {
        ...
        {
            if (Session["CKFinder_UserRole"] == "Customer")
            {
                AccessControl acl = AccessControl.Add();
                acl.Role = "*";
                acl.ResourceType = "*";
                ...
                type = ResourceType.Add(id);
                type.Url = BaseUrl + "Images_Public/" + id;
                type.MaxSize = 0;
                type.Dir = BaseDir == "" ? "" : BaseDir + "Images_Public/" + id;
                type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
                type.DeniedExtensions = new string[] { };
            }
        }
