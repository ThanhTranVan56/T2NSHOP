...
namespace T2NSHOP.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            {
                ViewBag.checkUrl = "yes";
                ViewBag.ReturnUrl = returnUrl;
                return View();
            }
            else
            {
                ViewBag.checkUrl = null;
                ViewBag.ReturnUrl = returnUrl;
                return View();
            }
        }
        ...
        [AllowAnonymous]
        public ActionResult LoginAddCart(string returnUrl)
        {
            ViewBag.ReturnUrl = returnUrl;
            return View();
        }
        ...
        public async Task<ActionResult> LoginAddCart(LoginViewModel model, string returnUrl)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    string contentAdmin = System.IO.File.ReadAllText(Server.MapPath("~/Content/templates/RegisterSendMail.html"));
                    contentAdmin = contentAdmin.Replace("{{callbackUrl}}", callbackUrl);

                    T2NSHOP.Common.Common.SendMail("TTK Shop", "Xác nhận tài khoản TTK Shop", contentAdmin.ToString(), user.Email);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    string contentAdmin = System.IO.File.ReadAllText(Server.MapPath("~/Content/templates/ResetPassworkSendMail.html"));
                    contentAdmin = contentAdmin.Replace("{{callbackUrl}}", callbackurl);

                    T2NSHOP.Common.Common.SendMail("TTK Shop", "Xác nhận Email thay đổi mật khẩu", contentAdmin.ToString(), user.Email);
